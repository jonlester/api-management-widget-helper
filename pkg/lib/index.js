...
class StorageManager {
    constructor(storageType = exports.StorageType.SessionStorage) {
        if (storageType === exports.StorageType.LocalStorage) {
...
class MessageBroker {
    constructor(channelName) {
        ...
        this.channel = new broadcastChannel.BroadcastChannel(name);
